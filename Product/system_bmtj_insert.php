	...
	if(isset($_POST["submit_zj"]) && $_POST["submit_zj"] == "保存")
		{
			...
			if($tcr == "" || $wtms == "" || $cljg == "" || $clr == "")
				{
					echo "<script>alert('请填写完整');location.href='system_bmtj.php'</script>";
				}
			else
				{
					...
					$sql = "insert into system_bmtj (zt,yxj,jlr,tcr,wtms,cljg,clr,wcrq,bz) values ('$zt','$yxj','$jlr','$tcr','$wtms','$cljg','$clr','$wcrq','$bz')";
					$sql_clgc = "insert into system_bmtj_clgc (wtms,clgc,bjr) values ('$wtms','$cljg','$jlr')";
