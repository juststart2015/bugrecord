...
<body>
    <div class="easyui-layout" fit="true">
    	<div region="center" fit="true">
			<table id="tt" class="easyui-datagrid" style="height:100%" fitColumns="true" title="搜索" iconCls="icon-search" toolbar="#tb" rownumbers="true" pagination="true" url="system_tjqy_select.php" nowrap="false" singleselect="true">
    			<thead>
                    <tr>
                        ...
                        <th field="wcrq" width="38" sortable="true">完成日期</th>
                    </tr>
                </thead>
            </table>
            ...
            <div id="tb" style="padding:3px;">
                ...
                <p>
					...
					<span>优先级：</span>
					<select id="yxj" style="width:70px">
						<option value="">全部</option>
            ...
            <div class="easyui-window" id="win_add" title="增加" style="width:95%;height:95%;" closed="true">
            	<form id="zj" style="padding:10px 20px 10px 40px;" action="system_tjqy_insert.php" method="post">
                	<p>
            ...
            <div class="easyui-dialog" id="win_edit" title="编辑" style="width:95%;height:95%;" closed="true">
				<div style="display:none">
					...
					<input type="text" name="tablename" value="system_tjqy_clgc" />
					<input name="submit_zd" />
					</form>
				</div>
				
            	<form style="padding:10px 20px 10px 40px;" action="system_tjqy_edit.php" method="post" id="fm" name="form_edit">
					...
					<div style="display:none">
						<input type="text" id="wt_lx" name="wt_lx" value="提交齐杨" />
					</div>
					...
					<legend>信息</legend>
                    <p>
                    	是否完成：<select name="zt" id="zt" style="width:70px;">
            			<option value="已完成">已完成</option>
						<option value="可更新">可更新</option>
                		<option value="处理中">处理中</option>
            			</select>
                    	提出人：<input type="text" name="tcr" readonly="readonly" style="border:hidden; width:80px" />
