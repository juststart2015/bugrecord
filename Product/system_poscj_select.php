<?php
	...
	$lx = isset($_POST['lx']) ? mysql_real_escape_string($_POST['lx']) : '';
	...
	$where = "djrq between '$ksrq' and '$jsrq' and wt_id like '$id%' and zt like '$zt%' and lx like '$lx%' and tcr like '$tcr%' and wtms like '%$wtms%' and cljg like '%$cljg%'";//模糊查询语句like
	$rs = mysql_query("select count(*) from system_poscj where " . $where);
	...
	$rs = mysql_query("select * from system_poscj where " . $where . " order by $sort $order limit $offset,$rows");
