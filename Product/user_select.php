<?php
	...
	$yhm = isset($_POST['yhm']) ? mysql_real_escape_string($_POST['yhm']) : '';
	$yhz = isset($_POST['yhz']) ? mysql_real_escape_string($_POST['yhz']) : '';
	...
	$where = "username like '%$yhm%' and policy like '%$yhz%'";//模糊查询语句like
