    ...
    <div class="easyui-layout" fit="true">
    	<div region="center" fit="true">
            ...
            <div class="easyui-window" id="win_add" title="增加" style="width:95%;height:95%;" closed="true">
            	<form id="zj" style="padding:10px 20px 10px 40px;" action="system_qt_insert.php" method="post">
                	<p>
            ...
            <div class="easyui-dialog" id="win_edit" title="编辑" style="width:95%;height:95%;" closed="true">
				<div style="display:none">
					...
					<input type="text" name="tablename" value="system_qt_clgc" />
					<input name="submit_zd" />
					</form>
				</div>
				
            	<form style="padding:10px 20px 10px 40px;" action="system_qt_edit.php" method="post" id="fm" name="form_edit">
					...
					<div style="display:none">
						<input type="text" id="wt_lx" name="wt_lx" value="其他" />
					</div>
