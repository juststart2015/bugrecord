...
<body>
    <div class="easyui-layout" fit="true">
    	<div region="center" fit="true">
			<table id="tt" class="easyui-datagrid" style="height:100%" fitColumns="true" title="搜索" iconCls="icon-search" toolbar="#tb" rownumbers="true" pagination="true" url="system_hy_select.php" nowrap="false" singleselect="true">
    			<thead>
                    <tr>
            ...
            <div class="easyui-window" id="win_add" title="增加" style="width:95%;height:95%;" closed="true">
            	<form id="zj" style="padding:10px 20px 10px 40px;" action="system_hy_insert.php" method="post">
                	<p>
            ...
            <div class="easyui-dialog" id="win_edit" title="编辑" style="width:95%;height:95%;" closed="true">
				<div style="display:none">
					...
					<input type="text" name="tablename" value="system_hy_clgc" />
					<input name="submit_zd" />
					</form>
				</div>
				
            	<form style="padding:10px 20px 10px 40px;" action="system_hy_edit.php" method="post" id="fm" name="form_edit">
					...
					<div style="display:none">
						<input type="text" id="wt_lx" name="wt_lx" value="会员" />
					</div>
