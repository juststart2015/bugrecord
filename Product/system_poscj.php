...
<body>
    <div class="easyui-layout" fit="true">
    	<div region="center" fit="true">
			<table id="tt" class="easyui-datagrid" style="height:100%" fitColumns="true" title="搜索" iconCls="icon-search" toolbar="#tb" rownumbers="true" pagination="true" url="system_poscj_select.php" nowrap="false" singleselect="true">
    			<thead>
                    <tr>
						<th field="wt_id" width="13" sortable="true">ID</th>
                        <th field="zt" width="25" sortable="true">状态</th>
						<th field="lx" width="23" sortable="true">类型</th>
                        <th field="tcr" width="26" sortable="true">提出人</th>
                        <th field="djrq" width="38" sortable="true">登记日期</th>
            ...
            <div id="tb" style="padding:3px;">
                ...
                <p>
					...
					<span>类型</span>
					<select id="lx" style="width:70px">
						<option value="">全部</option>
						<option value="电费">电费</option>
						<option value="水费">水费</option>
						<option value="有线电视费">有线电视费</option>
					</select>
            ...
            <div class="easyui-window" id="win_add" title="增加" style="width:95%;height:95%;" closed="true">
            	<form id="zj" style="padding:10px 20px 10px 40px;" action="system_poscj_insert.php" method="post">
                	<p>
						...
						类型：<select name="lx" style="width:70px">
						<option value="电费">电费</option>
						<option value="水费">水费</option>
						<option value="有线电视费">有线电视费</option>
						</select>
            ...
            <div class="easyui-dialog" id="win_edit" title="编辑" style="width:95%;height:95%;" closed="true">
				<div style="display:none">
					...
					<input type="text" name="tablename" value="system_poscj_clgc" />
            	...
            	<form style="padding:10px 20px 10px 40px;" action="system_poscj_edit.php" method="post" id="fm" name="form_edit">
					...
					<legend>信息</legend>
                    <p>
                    	状态：<select name="zt" id="bj_zt" style="width:70px;">
            			<option value="已完成">已完成</option>
                		<option value="处理中">处理中</option>
            			</select>
                    ...
                    <div style="float:left; clear:left">
                    <p>
						类型：<select name="lx" id="bj_lx" style="width:70px">
						<option value="电费">电费</option>
						<option value="水费">水费</option>
						<option value="有线电视费">有线电视费</option>
						</select>
